...
if (isset($_REQUEST['doGo'])) {
    ...
    if (!$error) {
        ...
        $headers .= "To: <$email>\r\n";
        $headers .= "From: <orangelemoncoder@gmail.com>\r\n";
        // Сообщение для Email
        $message = '
                <html>
                <head>
                ...
                <body>
                <p>Что бы подтвердить Email, перейдите по <a href="http://localhost/email_verification/confirmed.php?hash=' . $hash . '">ссылка</a></p>
                </body>
                </html>
                ';
